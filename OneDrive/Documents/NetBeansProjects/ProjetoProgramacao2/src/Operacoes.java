...
public class Operacoes {
    ...
    public void cadastrarFuncionarios(String nome, String nivel, String usuario, String senha) {
        Connection con = null;
        PreparedStatement pst = null;
        
        try {
            con = Conexao.conector();
            String sql = "INSERT INTO login (nomeFuncionario, nivel, usuario, senha) VALUES (?, ?, ?, ?)";
            pst = con.prepareStatement(sql);
            pst.setString(1, nome);
    ...
    public void atualizarFuncionarios(String nome, String nivel, String usuario,String senha, int id){
        con = Conexao.conector();
        String sql = "update login set nomeFuncionario=?,nivel=?,usuario=?,senha=? where idLogin=?";
        try {
            pst = con.prepareStatement(sql);
            pst.setString(1, nome);
