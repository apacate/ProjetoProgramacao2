...
public void salvar() {
    ...
    if (txtNome.getText().isEmpty() || txtApelido.getText().isEmpty() || txtNumeroEstudante.getText().isEmpty()) {
        ...
        try (Connection con = Conexao.conector()) {
...
public void apagar(){
    ...
    public void preencherTabela(){
        ...
        try {
            ...
            while(rst.next()){
               modelo.addRow(new Object[]{rst.getString("numero_estudante"), rst.getString("nome"), rst.getString("apelido"), rst.getString("curso")});
            }
        } catch (Exception ex) {
